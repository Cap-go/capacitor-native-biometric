...
| **`description`**        | <code>string</code> | Description for the biometric prompt. Only for Android.                                                                                                    |
| **`negativeButtonText`** | <code>string</code> | Text for the negative/cancel button. Only for Android.                                                                                                     |
| **`fallbackTitle`**      | <code>string</code> | Set the text for the fallback button in the authentication dialog. If this property is not specified, the default text is set by the system. Only for iOS. |
