...
| **`title`**              | <code>string</code>                                     | Title for the biometric prompt shown while protecting credentials. Only for Android.                                                                                                                                                                                                                                                                                                                    | <code>"Protect Credentials"</code> |       |
| **`negativeButtonText`** | <code>string</code>                                     | Text for the negative/cancel button in the biometric prompt. Only for Android.                                                                                                                                                                                                                                                                                                                          | <code>"Cancel"</code>              |       |
